  ...
  if (!rateLimiters) {
    ...
    rateLimiters = {
      free: new Ratelimit({
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:color:free',
      }),
      starter: new Ratelimit({
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:color:starter',
      }),
      pro: new Ratelimit({
        redis: redisInstance,
        limiter: Ratelimit.slidingWindow(
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:color:pro',
      }),
      enterprise: new Ratelimit({
        ...
        analytics: true,
        prefix: 'endpnt:ratelimit:color:enterprise',
      }),
    }
  }
  return rateLimiters
...
function initializeDemoRateLimit() {
  if (!demoRateLimit) {
    ...
    demoRateLimit = new Ratelimit({
      ...
      analytics: true,
      prefix: 'endpnt:ratelimit:color:demo',
    })
  }
